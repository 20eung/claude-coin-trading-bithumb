...
└──────────────────────┬──────────────────────────────────┘
        ...
        ┌──────────────┼──────────────┐
        ▼              ▼              ▼
   Bithumb API   Alternative.me   Tavily API
   (시세/호가)   (공포탐욕지수)    (뉴스)
        │              │              │
        └──────────────┼──────────────┘
                       ▼
...
| 서비스 | 용도 | 발급 |
|--------|------|------|
| Bithumb | 시세 조회 + 매매 실행 | [빗썸 API 관리](https://www.bithumb.com/api_support/management) |
...
| 1 | "Bithumb API로 시장 데이터를 수집해줘" | collect_market_data.py |
...
├── setup.sh                       # 설치 스크립트
├── scripts/
│   ├── collect_market_data.py     # Bithumb 시세 + 기술지표
...
| 구분 | 출처 | URL |
|------|------|-----|
| 거래소 API | Bithumb Open API | https://apidocs.bithumb.com |
| 시장 심리 지수 | Alternative.me Crypto Fear & Greed Index | https://alternative.me/crypto/fear-and-greed-index/#api |
| 뉴스 검색 | Tavily Search API | https://docs.tavily.com |
| 차트 위젯 | TradingView Widgets | https://www.tradingview.com/widget/ |
| 데이터베이스 | Supabase (PostgreSQL) | https://supabase.com/docs |
| 알림 봇 | Telegram Bot API | https://core.telegram.org/bots/api |
| 차트 캡처 | Playwright for Python | https://playwright.dev/python/docs/intro |
| AI 엔진 | Claude Code (Anthropic) | https://docs.anthropic.com/en/docs/claude-code |
| 원본 프로젝트 (Upbit 버전) | Dante Labs | https://github.com/dandacompany/claude-coin-trading |
